...
$COMPOSE_CMD --env-file .env -f infra/docker-compose.prod.yml ps -a
...
$COMPOSE_CMD --env-file .env -f infra/docker-compose.prod.yml exec -T app php artisan migrate --force
...
$COMPOSE_CMD --env-file .env -f infra/docker-compose.prod.yml exec -T app php artisan view:cache
